...
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"Desarrollo y Mantenimiento de Sistemas Informáticos","url":"/node_modules/qs/"}</script>
<!-- End Jekyll SEO tag -->

    <link rel="stylesheet" href="/assets/css/style.css?v=c097c1ae73c4f428cb0b3274f1df53633722ad0b">
...
<a href="https://npm-stat.com/charts.html?package=qs"><img src="https://img.shields.io/npm/dm/qs.svg" alt="Downloads" /></a>
<a href="https://bestpractices.coreinfrastructure.org/projects/9058"><img src="https://bestpractices.coreinfrastructure.org/projects/9058/badge" alt="CII Best Practices" /></a></p>
...
This means if you attempt to parse a string like <code class="language-plaintext highlighter-rouge">'a[b][c][d][e][f][g][h][i]=j'</code> your resulting object will be:</p>
...
<p>You can configure <strong>qs</strong> to throw an error when parsing nested input beyond this depth using the <code class="language-plaintext highlighter-rouge">strictDepth</code> option (defaulted to false):</p>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">try</span> <span class="p">{</span>
    <span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">a[b][c][d][e][f][g][h][i]=j</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">depth</span><span class="p">:</span> <span class="mi">1</span><span class="p">,</span> <span class="na">strictDepth</span><span class="p">:</span> <span class="kc">true</span> <span class="p">});</span>
<span class="p">}</span> <span class="k">catch</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">assert</span><span class="p">(</span><span class="nx">err</span> <span class="k">instanceof</span> <span class="nx">RangeError</span><span class="p">);</span>
    <span class="nx">assert</span><span class="p">.</span><span class="nx">strictEqual</span><span class="p">(</span><span class="nx">err</span><span class="p">.</span><span class="nx">message</span><span class="p">,</span> <span class="dl">'</span><span class="s1">Input depth exceeded depth option of 1 and strictDepth is true</span><span class="dl">'</span><span class="p">);</span>
<span class="p">}</span>
</code></pre></div></div>
...
<p>Option <code class="language-plaintext highlighter-rouge">decodeDotInKeys</code> can be used to decode dots in keys
Note: it implies <code class="language-plaintext highlighter-rouge">allowDots</code>, so <code class="language-plaintext highlighter-rouge">parse</code> will error if you set <code class="language-plaintext highlighter-rouge">decodeDotInKeys</code> to <code class="language-plaintext highlighter-rouge">true</code>, and <code class="language-plaintext highlighter-rouge">allowDots</code> to <code class="language-plaintext highlighter-rouge">false</code>.</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">withDots</span> <span class="o">=</span> <span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">name%252Eobj.first=John&amp;name%252Eobj.last=Doe</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">decodeDotInKeys</span><span class="p">:</span> <span class="kc">true</span> <span class="p">});</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">withDots</span><span class="p">,</span> <span class="p">{</span> <span class="dl">'</span><span class="s1">name.obj</span><span class="dl">'</span><span class="p">:</span> <span class="p">{</span> <span class="na">first</span><span class="p">:</span> <span class="dl">'</span><span class="s1">John</span><span class="dl">'</span><span class="p">,</span> <span class="na">last</span><span class="p">:</span> <span class="dl">'</span><span class="s1">Doe</span><span class="dl">'</span> <span class="p">}});</span>
</code></pre></div></div>

<p>Option <code class="language-plaintext highlighter-rouge">allowEmptyArrays</code> can be used to allowing empty array values in object</p>
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">withEmptyArrays</span> <span class="o">=</span> <span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo[]&amp;bar=baz</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">allowEmptyArrays</span><span class="p">:</span> <span class="kc">true</span> <span class="p">});</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">withEmptyArrays</span><span class="p">,</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="p">[],</span> <span class="na">bar</span><span class="p">:</span> <span class="dl">'</span><span class="s1">baz</span><span class="dl">'</span> <span class="p">});</span>
</code></pre></div></div>

<p>Option <code class="language-plaintext highlighter-rouge">duplicates</code> can be used to change the behavior when duplicate keys are encountered</p>
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo=bar&amp;foo=baz</span><span class="dl">'</span><span class="p">),</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">baz</span><span class="dl">'</span><span class="p">]</span> <span class="p">});</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo=bar&amp;foo=baz</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">duplicates</span><span class="p">:</span> <span class="dl">'</span><span class="s1">combine</span><span class="dl">'</span> <span class="p">}),</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">baz</span><span class="dl">'</span><span class="p">]</span> <span class="p">});</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo=bar&amp;foo=baz</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">duplicates</span><span class="p">:</span> <span class="dl">'</span><span class="s1">first</span><span class="dl">'</span> <span class="p">}),</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">bar</span><span class="dl">'</span> <span class="p">});</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">deepEqual</span><span class="p">(</span><span class="nx">qs</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="dl">'</span><span class="s1">foo=bar&amp;foo=baz</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">duplicates</span><span class="p">:</span> <span class="dl">'</span><span class="s1">last</span><span class="dl">'</span> <span class="p">}),</span> <span class="p">{</span> <span class="na">foo</span><span class="p">:</span> <span class="dl">'</span><span class="s1">baz</span><span class="dl">'</span> <span class="p">});</span>
</code></pre></div></div>
...
<p>Some services add an initial <code class="language-plaintext highlighter-rouge">utf8=✓</code> value to forms so that old Internet Explorer versions are more likely to submit the form as utf-8.
Additionally, the server can check the value against wrong encodings of the checkmark character and detect that a query string or <code class="language-plaintext highlighter-rouge">application/x-www-form-urlencoded</code> body was <em>not</em> sent as utf-8, eg. if the form had an <code class="language-plaintext highlighter-rouge">accept-charset</code> parameter or the containing page had a different character set.</p>
...
If specified, the <code class="language-plaintext highlighter-rouge">utf8</code> parameter will be omitted from the returned object.
It will be used to switch to <code class="language-plaintext highlighter-rouge">iso-8859-1</code>/<code class="language-plaintext highlighter-rouge">utf-8</code> mode depending on how the checkmark is encoded.</p>

<p><strong>Important</strong>: When you specify both the <code class="language-plaintext highlighter-rouge">charset</code> option and the <code class="language-plaintext highlighter-rouge">charsetSentinel</code> option, the <code class="language-plaintext highlighter-rouge">charset</code> will be overridden when the request contains a <code class="language-plaintext highlighter-rouge">utf8</code> parameter from which the actual charset can be deduced.
In that sense the <code class="language-plaintext highlighter-rouge">charset</code> will behave as the default charset rather than the authoritative charset.</p>
...
<p>If you want to decode the <code class="language-plaintext highlighter-rouge">&amp;#...;</code> syntax to the actual character, you can specify the <code class="language-plaintext highlighter-rouge">interpretNumericEntities</code> option as well:</p>
...
<p>It also works when the charset has been detected in <code class="language-plaintext highlighter-rouge">charsetSentinel</code> mode.</p>
...
<p><strong>qs</strong> will also limit specifying indices in an array to a maximum index of <code class="language-plaintext highlighter-rouge">20</code>.
Any array members with an index of greater than <code class="language-plaintext highlighter-rouge">20</code> will instead be converted to an object with the index as the key.
This is needed to handle cases when someone sent, for example, <code class="language-plaintext highlighter-rouge">a[999999999]</code> and it will take significant time to iterate over this huge array.</p>
...
<p>When arrays are stringified, they follow the <code class="language-plaintext highlighter-rouge">arrayFormat</code> option, which defaults to <code class="language-plaintext highlighter-rouge">indices</code>:</p>
...
<p>You may override this by setting the <code class="language-plaintext highlighter-rouge">indices</code> option to <code class="language-plaintext highlighter-rouge">false</code>, or to be more explicit, the <code class="language-plaintext highlighter-rouge">arrayFormat</code> option to <code class="language-plaintext highlighter-rouge">repeat</code>:</p>
...
<p>You may encode the dot notation in the keys of object with option <code class="language-plaintext highlighter-rouge">encodeDotInKeys</code> by setting it to <code class="language-plaintext highlighter-rouge">true</code>:
Note: it implies <code class="language-plaintext highlighter-rouge">allowDots</code>, so <code class="language-plaintext highlighter-rouge">stringify</code> will error if you set <code class="language-plaintext highlighter-rouge">decodeDotInKeys</code> to <code class="language-plaintext highlighter-rouge">true</code>, and <code class="language-plaintext highlighter-rouge">allowDots</code> to <code class="language-plaintext highlighter-rouge">false</code>.
Caveat: when <code class="language-plaintext highlighter-rouge">encodeValuesOnly</code> is <code class="language-plaintext highlighter-rouge">true</code> as well as <code class="language-plaintext highlighter-rouge">encodeDotInKeys</code>, only dots in keys and nothing else will be encoded.</p>
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">qs</span><span class="p">.</span><span class="nx">stringify</span><span class="p">({</span> <span class="dl">"</span><span class="s2">name.obj</span><span class="dl">"</span><span class="p">:</span> <span class="p">{</span> <span class="dl">"</span><span class="s2">first</span><span class="dl">"</span><span class="p">:</span> <span class="dl">"</span><span class="s2">John</span><span class="dl">"</span><span class="p">,</span> <span class="dl">"</span><span class="s2">last</span><span class="dl">"</span><span class="p">:</span> <span class="dl">"</span><span class="s2">Doe</span><span class="dl">"</span> <span class="p">}</span> <span class="p">},</span> <span class="p">{</span> <span class="na">allowDots</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span> <span class="na">encodeDotInKeys</span><span class="p">:</span> <span class="kc">true</span> <span class="p">})</span>
<span class="c1">// 'name%252Eobj.first=John&amp;name%252Eobj.last=Doe'</span>
</code></pre></div></div>

<p>You may allow empty array values by setting the <code class="language-plaintext highlighter-rouge">allowEmptyArrays</code> option to <code class="language-plaintext highlighter-rouge">true</code>:</p>
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">qs</span><span class="p">.</span><span class="nx">stringify</span><span class="p">({</span> <span class="na">foo</span><span class="p">:</span> <span class="p">[],</span> <span class="na">bar</span><span class="p">:</span> <span class="dl">'</span><span class="s1">baz</span><span class="dl">'</span> <span class="p">},</span> <span class="p">{</span> <span class="na">allowEmptyArrays</span><span class="p">:</span> <span class="kc">true</span> <span class="p">});</span>
...
<p>You could also use <code class="language-plaintext highlighter-rouge">filter</code> to inject custom serialization for user defined types.
Consider you’re working with some api that expects query strings of the format for ranges:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>https://domain.com/endpoint?range=30...70
</code></pre></div></div>

<p>For which you model as:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">class</span> <span class="nx">Range</span> <span class="p">{</span>
    <span class="kd">constructor</span><span class="p">(</span><span class="k">from</span><span class="p">,</span> <span class="nx">to</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">qs</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span>
    <span class="p">{</span>
        <span class="na">range</span><span class="p">:</span> <span class="k">new</span> <span class="nx">Range</span><span class="p">(</span><span class="mi">30</span><span class="p">,</span> <span class="mi">70</span><span class="p">),</span>
    <span class="p">},</span>
    <span class="p">{</span>
        <span class="na">filter</span><span class="p">:</span> <span class="p">(</span><span class="nx">prefix</span><span class="p">,</span> <span class="nx">value</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
            <span class="k">if</span> <span class="p">(</span><span class="nx">value</span> <span class="k">instanceof</span> <span class="nx">Range</span><span class="p">)</span> <span class="p">{</span>
                <span class="k">return</span> <span class="s2">`</span><span class="p">${</span><span class="nx">value</span><span class="p">.</span><span class="k">from</span><span class="p">}</span><span class="s2">...</span><span class="p">${</span><span class="nx">value</span><span class="p">.</span><span class="nx">to</span><span class="p">}</span><span class="s2">`</span><span class="p">;</span>
            <span class="p">}</span>
            <span class="c1">// serialize the usual way</span>
            <span class="k">return</span> <span class="nx">value</span><span class="p">;</span>
        <span class="p">},</span>
    <span class="p">}</span>
<span class="p">);</span>
...
<p>If you’re communicating with legacy systems, you can switch to <code class="language-plaintext highlighter-rouge">iso-8859-1</code> using the <code class="language-plaintext highlighter-rouge">charset</code> option:</p>
...
<p>Characters that don’t exist in <code class="language-plaintext highlighter-rouge">iso-8859-1</code> will be converted to numeric entities, similar to what browsers do:</p>
...
<p>By default the encoding and decoding of characters is done in <code class="language-plaintext highlighter-rouge">utf-8</code>, and <code class="language-plaintext highlighter-rouge">iso-8859-1</code> support is also built in via the <code class="language-plaintext highlighter-rouge">charset</code> parameter.</p>
...
<ol>
  ...
  <li> 
    <a href="/tema1-introduccion/practicas/nextauth">NextAuth.js</a> 
    <ol>
      ...
      <li><a href="/tema1-introduccion/practicas/nextauth#rúbrica">Rúbrica</a> </li>
    </ol>
  </li>
  ...
  <li> 
    <a href="/tema1-introduccion/practicas/nextjs-intro">Introduction to Next.js with v0</a> 
    <ol>
      <li>Repos en GH: <a href="https://github.com/orgs/ULL-ESIT-DMSI-2425/repositories?q=nextjs-intro&type=all&language=&sort=" target="_blank">nextjs-intro</a></li>
      <li><a href="/tema1-introduccion/practicas/nextjs-intro#rúbrica">Rúbrica</a> </li>
    </ol>
  </li>
...
<li> <a href="/2024/12/18/leccion.html">Clase del Miércoles 2024/12/11</a></li>
  
<li> <a href="/2024/12/16/leccion.html">Clase del Miércoles 2024/12/11</a></li>
  
<li> <a href="/2024/12/11/leccion.html">Clase del Miércoles 2024/12/11</a></li>
  
<li> <a href="/2024/12/09/leccion.html">Clase del Lunes 2024/12/09</a></li>
  
<li> <a href="/2024/12/04/leccion.html">Clase del Miércoles 2024/12/04</a></li>
  
<li> <a href="/2024/12/02/leccion.html">Clase del Lunes 2024/12/02</a></li>
  
<li> <a href="/2024/11/27/leccion.html">Clase del Miércoles 2024/11/27</a></li>
  
<li> <a href="/2024/11/25/leccion.html">Clase del Lunes 2024/11/25</a></li>
