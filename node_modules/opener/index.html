...
<title>It Opens Stuff | Desarrollo y Mantenimiento de Sistemas Informáticos</title>
<meta name="generator" content="Jekyll v3.9.2" />
<meta property="og:title" content="It Opens Stuff" />
...
<meta property="twitter:title" content="It Opens Stuff" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"It Opens Stuff","url":"/node_modules/opener/"}</script>
<!-- End Jekyll SEO tag -->
...
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm <span class="nb">install </span>opener <span class="nt">-g</span>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">opener</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">opener</span><span class="dl">"</span><span class="p">);</span>

<span class="nx">opener</span><span class="p">(</span><span class="dl">"</span><span class="s2">http://google.com</span><span class="dl">"</span><span class="p">);</span>
<span class="nx">opener</span><span class="p">(</span><span class="dl">"</span><span class="s2">./my-file.txt</span><span class="dl">"</span><span class="p">);</span>
<span class="nx">opener</span><span class="p">(</span><span class="dl">"</span><span class="s2">firefox</span><span class="dl">"</span><span class="p">);</span>
<span class="nx">opener</span><span class="p">(</span><span class="dl">"</span><span class="s2">npm run lint</span><span class="dl">"</span><span class="p">);</span>
</code></pre></div></div>

<p>Plus, it returns the child process created, so you can do things like let your script exit while the window stays open:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">editor</span> <span class="o">=</span> <span class="nx">opener</span><span class="p">(</span><span class="dl">"</span><span class="s2">documentation.odt</span><span class="dl">"</span><span class="p">);</span>
...
<div class="language-json highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="p">{</span><span class="w">
        ...
        </span><span class="nl">"test"</span><span class="p">:</span><span class="w"> </span><span class="s2">"opener ./test/runner.html"</span><span class="w">
    </span><span class="p">},</span><span class="w">
    </span><span class="nl">"devDependencies"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w">
        </span><span class="nl">"opener"</span><span class="p">:</span><span class="w"> </span><span class="s2">"*"</span><span class="w">
    </span><span class="p">}</span><span class="w">
</span><span class="p">}</span><span class="w">
...
<p>Because Windows has <code class="language-plaintext highlighter-rouge">start</code>, Macs have <code class="language-plaintext highlighter-rouge">open</code>, and *nix has <code class="language-plaintext highlighter-rouge">xdg-open</code>. At least <a href="http://stackoverflow.com/q/1480971/3191">according to some person on StackOverflow</a>. And I like things that work on all three. Like Node.js. And Opener.</p>
