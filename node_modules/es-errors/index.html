...
<title>es-errors [![Version Badge][npm-version-svg]][package-url] | Desarrollo y Mantenimiento de Sistemas Informáticos</title>
<meta name="generator" content="Jekyll v3.9.2" />
<meta property="og:title" content="es-errors [![Version Badge][npm-version-svg]][package-url]" />
...
<meta property="twitter:title" content="es-errors [![Version Badge][npm-version-svg]][package-url]" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"es-errors [![Version Badge][npm-version-svg]][package-url]","url":"/node_modules/es-errors/"}</script>
<!-- End Jekyll SEO tag -->
...
<body>
    ...
    <div class="wrapper">
        ...
        <section>
            ...
            <h1 id="es-errors-">es-errors <sup><a href="https://npmjs.org/package/es-errors"><img src="https://versionbadg.es/ljharb/es-errors.svg" alt="Version Badge" /></a></sup></h1>

<p><a href="https://github.com/ljharb/es-errors/actions"><img src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/es-errors" alt="github actions" /></a>
<a href="https://app.codecov.io/gh/ljharb/es-errors/"><img src="https://codecov.io/gh/ljharb/es-errors/branch/main/graphs/badge.svg" alt="coverage" /></a>
<a href="/node_modules/es-errors/LICENSE"><img src="https://img.shields.io/npm/l/es-errors.svg" alt="License" /></a>
<a href="https://npm-stat.com/charts.html?package=es-errors"><img src="https://img.shields.io/npm/dm/es-errors.svg" alt="Downloads" /></a></p>

<p><a href="https://npmjs.org/package/es-errors"><img src="https://nodei.co/npm/es-errors.png?downloads=true&amp;stars=true" alt="npm badge" /></a></p>
...
<span class="kd">const</span> <span class="nx">Base</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">Eval</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/eval</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">Range</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/range</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">Ref</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/ref</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">Syntax</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/syntax</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">Type</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/type</span><span class="dl">'</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">URI</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">es-errors/uri</span><span class="dl">'</span><span class="p">);</span>

<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Base</span><span class="p">,</span> <span class="nb">Error</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Eval</span><span class="p">,</span> <span class="nx">EvalError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Range</span><span class="p">,</span> <span class="nx">RangeError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Ref</span><span class="p">,</span> <span class="nx">ReferenceError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Syntax</span><span class="p">,</span> <span class="nx">SyntaxError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Type</span><span class="p">,</span> <span class="nx">TypeError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">URI</span><span class="p">,</span> <span class="nx">URIError</span><span class="p">);</span>
</code></pre></div></div>
