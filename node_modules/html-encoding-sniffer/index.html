...
<title>Determine the Encoding of a HTML Byte Stream | Desarrollo y Mantenimiento de Sistemas Informáticos</title>
...
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"Determine the Encoding of a HTML Byte Stream","url":"/node_modules/html-encoding-sniffer/"}</script>
<!-- End Jekyll SEO tag -->
...
<span class="kd">const</span> <span class="nx">htmlBytes</span> <span class="o">=</span> <span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="dl">"</span><span class="s2">./html-page.html</span><span class="dl">"</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">sniffedEncoding</span> <span class="o">=</span> <span class="nx">htmlEncodingSniffer</span><span class="p">(</span><span class="nx">htmlBytes</span><span class="p">);</span>
</code></pre></div></div>

<p>The passed bytes are given as a <code class="language-plaintext highlighter-rouge">Uint8Array</code>; the Node.js <code class="language-plaintext highlighter-rouge">Buffer</code> subclass of <code class="language-plaintext highlighter-rouge">Uint8Array</code> will also work, as shown above.</p>
...
<span class="kd">const</span> <span class="nx">htmlString</span> <span class="o">=</span> <span class="nx">whatwgEncoding</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="nx">htmlBytes</span><span class="p">,</span> <span class="nx">sniffedEncoding</span><span class="p">);</span>
</code></pre></div></div>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">sniffedEncoding</span> <span class="o">=</span> <span class="nx">htmlEncodingSniffer</span><span class="p">(</span><span class="nx">htmlBytes</span><span class="p">,</span> <span class="p">{</span>
