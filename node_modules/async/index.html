...
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"Desarrollo y Mantenimiento de Sistemas Informáticos","url":"/node_modules/async/"}</script>
<!-- End Jekyll SEO tag -->
...
<p>Async is a utility module which provides straight-forward, powerful functions for working with <a href="http://caolan.github.io/async/global.html">asynchronous JavaScript</a>. Although originally designed for use with <a href="https://nodejs.org/">Node.js</a> and installable via <code class="language-plaintext highlighter-rouge">npm install --save async</code>, it can also be used directly in the browser.</p>

<p>This version of the package is optimized for the Node.js environment. If you use Async with webpack, install <a href="https://www.npmjs.com/package/async-es"><code class="language-plaintext highlighter-rouge">async-es</code></a> instead.</p>
