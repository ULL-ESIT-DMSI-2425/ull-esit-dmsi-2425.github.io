...
<title>node-portfinder | Desarrollo y Mantenimiento de Sistemas Informáticos</title>
<meta name="generator" content="Jekyll v3.9.2" />
<meta property="og:title" content="node-portfinder" />
...
<meta property="twitter:title" content="node-portfinder" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","description":"4º. 1er cuatrimestre. Itinerario de Sistemas de la Información. Grado en Ingeniería Informática. ULL","headline":"node-portfinder","url":"/node_modules/portfinder/"}</script>
<!-- End Jekyll SEO tag -->
...
<body>
    ...
    <div class="wrapper">
        ...
        <section>
            ...
            <h1 id="node-portfinder-">node-portfinder <a href="https://github.com/http-party/node-portfinder/actions/workflows/ci.yml"><img src="https://github.com/http-party/node-portfinder/actions/workflows/ci.yml/badge.svg?branch=master" alt="CI" /></a></h1>

<h2 id="installation">Installation</h2>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="nv">$ </span>npm <span class="nb">install </span>portfinder
</code></pre></div></div>

<h2 id="usage">Usage</h2>
<p>The <code class="language-plaintext highlighter-rouge">portfinder</code> module has a simple interface:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="kd">var</span> <span class="nx">portfinder</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">portfinder</span><span class="dl">'</span><span class="p">);</span>

  <span class="nx">portfinder</span><span class="p">.</span><span class="nx">getPort</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">port</span><span class="p">)</span> <span class="p">{</span>
    <span class="c1">//</span>
    <span class="c1">// `port` is guaranteed to be a free port</span>
    <span class="c1">// in this scope.</span>
    <span class="c1">//</span>
  <span class="p">});</span>
</code></pre></div></div>

<p>Or with promise (if <code class="language-plaintext highlighter-rouge">Promise</code>s are supported) :</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code>  <span class="kd">const</span> <span class="nx">portfinder</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">portfinder</span><span class="dl">'</span><span class="p">);</span>

  <span class="nx">portfinder</span><span class="p">.</span><span class="nx">getPortPromise</span><span class="p">()</span>
    ...
    <span class="p">.</span><span class="k">catch</span><span class="p">((</span><span class="nx">err</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
        <span class="c1">//</span>
        <span class="c1">// Could not get a free port, `err` contains the reason.</span>
        <span class="c1">//</span>
    <span class="p">});</span>
</code></pre></div></div>

<p>If <code class="language-plaintext highlighter-rouge">portfinder.getPortPromise()</code> is called on a Node version without Promise (&lt;4), it will throw an Error unless <a href="http://bluebirdjs.com/docs/getting-started.html">Bluebird</a> or any Promise pollyfill is used.</p>

<h3 id="ports-search-scope">Ports search scope</h3>

<p>By default <code class="language-plaintext highlighter-rouge">portfinder</code> will start searching from <code class="language-plaintext highlighter-rouge">8000</code> and scan until maximum port number (<code class="language-plaintext highlighter-rouge">65535</code>) is reached.</p>

<p>You can change this globally by setting:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">portfinder</span><span class="p">.</span><span class="nx">setBasePort</span><span class="p">(</span><span class="mi">3000</span><span class="p">);</span>    <span class="c1">// default: 8000</span>
<span class="nx">portfinder</span><span class="p">.</span><span class="nx">setHighestPort</span><span class="p">(</span><span class="mi">3333</span><span class="p">);</span> <span class="c1">// default: 65535</span>
</code></pre></div></div>

<p>or by passing optional options object on each invocation:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">portfinder</span><span class="p">.</span><span class="nx">getPort</span><span class="p">({</span>
    <span class="na">port</span><span class="p">:</span> <span class="mi">3000</span><span class="p">,</span>    <span class="c1">// minimum port</span>
    <span class="na">stopPort</span><span class="p">:</span> <span class="mi">3333</span> <span class="c1">// maximum port</span>
...
<h4 id="author-charlie-robbins">Author: <a href="http://nodejitsu.com">Charlie Robbins</a></h4>
<h4 id="authormaintainer-erik-trom">Author/Maintainer: <a href="https://github.com/eriktrom">Erik Trom</a></h4>
